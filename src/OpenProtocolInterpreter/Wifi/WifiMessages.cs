...
namespace OpenProtocolInterpreter.Wifi
{
    ...
    internal class WifiMessages : MessagesTemplate
    {
        public WifiMessages() : base()
        {
            ...
            {
                { Mid0805.MID, new CompiledInstance<Mid>(typeof(Mid0805)) },
                { Mid0806.MID, new CompiledInstance<Mid>(typeof(Mid0806)) },
                { Mid0807.MID, new CompiledInstance<Mid>(typeof(Mid0807)) },
                { Mid0808.MID, new CompiledInstance<Mid>(typeof(Mid0808)) },
                { Mid0809.MID, new CompiledInstance<Mid>(typeof(Mid0809)) }
            };
        }
