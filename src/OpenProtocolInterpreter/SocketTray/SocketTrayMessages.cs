...
namespace OpenProtocolInterpreter.SocketTray
{
    ...
    internal class SocketTrayMessages : MessagesTemplate
    {
        public SocketTrayMessages() : base()
        {
            ...
            {
                { Mid0520.MID, new CompiledInstance<Mid>(typeof(Mid0520)) },
                { Mid0522.MID, new CompiledInstance<Mid>(typeof(Mid0522)) },
                { Mid0523.MID, new CompiledInstance<Mid>(typeof(Mid0523)) },
                { Mid0524.MID, new CompiledInstance<Mid>(typeof(Mid0524)) }
            };
        }
